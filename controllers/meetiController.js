...
exports.crearMeti = async(req,res)=>{
    ...
    try {
        ...
        if (error.errors && Array.isArray(error.errors)) {
            ...
            // Si no hay errores específicos de Sequelize, puedes manejar el error de otra manera
            console.error(error); // Imprime el error en la consola para depuración
            req.flash('error', 'Ocurrió un error al crear el Meeti');
        }
...
// Muestar el formulario  para eliminar
