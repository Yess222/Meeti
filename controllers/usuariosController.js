...
exports.formEditarPerifl = async (req,res) =>{
...
// almacena en la base de datos los cambios de perfil
exports.editarPerifl = async(req,res) =>{
...
exports.cambiarPassword= async(req,res,next) =>{
    ...
    req.flash('Exito','Password Modificado Correctamente,vuelve iniciar sesion');
    res.redirect('/iniciar-sesion');
}
...
// Guardar la imagen nueva, elimina la anterior(si aplica) y guarda el registro en la BD
